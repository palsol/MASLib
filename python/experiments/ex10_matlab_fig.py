...
def plotFig(filename, fignr=1):
    ...
    if legs:
        ...
        py_locs = ['upper center', 'lower center', 'right', 'left', 'upper right', 'upper left', 'lower right',
                   'lower left', 'best', 'best']
...
if __name__ == '__main__':
    d = loadmat('/home/palsol/CLionProjects/MASLib/data/IZHEVSK_2_h.fig', squeeze_me=True, struct_as_record=False)
    matfig = d['hgS_070000']
    childs = matfig.children
    ax1 = [c for c in childs if c.type == 'axes']
